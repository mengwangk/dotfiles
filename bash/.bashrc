...
export OSH=/home/mengwangk/.oh-my-bash
...
export PATH=$PATH:$HOME/.local/bin:~/workspace/software
...
__conda_setup="$('/home/mengwangk/miniconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
...
alias luamake=/home/mengwangk/workspace/software/lua-language-server/3rd/luamake/luamake
